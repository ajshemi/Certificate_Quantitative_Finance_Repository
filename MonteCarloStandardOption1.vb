...
'This code was modified(used Arrays type for select variables) to allow for Standard Deviation Calculations
...
'can calculate prices for European call and puts options
    ...
    ' for loop for standard deviation calculation
